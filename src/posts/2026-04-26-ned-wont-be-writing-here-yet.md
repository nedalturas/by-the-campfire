...
### The writer vs. The code writer

There is a fundamental conflict between being a writer and the builder of the site that your writing lives on.

* **As a writer:** I want to explore the nuances of human emotion or about the stoics 🤔
* **As a coder:** I just want the submit button to work 😭

This is his current "Hiatus", so he'd like to apologize for it. 

But he promised to write here as soon as his code won't fail for test cases.
